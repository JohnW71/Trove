...
#define ID_MAIN_ADD 2
#define ID_MAIN_EDIT 3
#define ID_MAIN_DELETE 4
#define ID_MAIN_SETTINGS 5
#define ID_MAIN_QUIT 6
#define ID_MAIN_FINDTEXT 7
#define ID_MAIN_FIND 8
#define ID_MAIN_LISTBOX 9
...
LRESULT CALLBACK customMainEditProc(HWND, UINT, WPARAM, LPARAM);
LRESULT CALLBACK customSetPasswordEditProc(HWND, UINT, WPARAM, LPARAM);
